...
import com.example.txbank.service.TxBankServiceMongo;
...
public class MyControllerBank {
	...
	@Autowired
	private TxBankServiceMongo txBankServiceMongo;
...
//	}
	...
	public String transferInfo(Model model, @RequestParam("typePayment") String typePayment,
			@RequestParam("amount") BigDecimal amount, @RequestParam("recipient") Long receiverBankCard,
		...
		UserBankInfoResponse userBankInfoResponse = txBankService.getUserByLogin(currentPrincipalName);
		int userBankId = userBankInfoResponse.getId();
		UserBankTransactionResponse userBankTransactionResponse = txBankService.transferMoney(typePayment, userBankId,
				receiverBankCard, amount, commentTransaction);
	...
	public String supportMessage(@RequestParam("userEmail") String userEmail,
